...
public class FighterRepository implements Persistent<Fighter>{
    ...
    public void insert(Fighter entity) {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO Fighter (NAME, AGE, Record,Rank, PHOTO,NICKNAME , Division) VALUES (?, ?, ?,?,?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
            ...
            preparedStatement.setString(6, entity.getNickName());
            preparedStatement.setString(7, entity.getDivisionName());
